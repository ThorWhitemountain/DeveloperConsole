...
namespace Anarkila.DeveloperConsole
{
    ...
    public class ConsoleMessageHandler : MonoBehaviour
    {
        ...
        private Dictionary<GameObject, ConsoleMessage> messages = new(256);
        private List<TempMessage> messagesBeforeInitDone = new(32);
        private List<GameObject> currentMessages = new(64);
        ...
        private void Awake()
        {
            ...
            if (content != null)
            {
                ...
                {
                    Debug.Log($"Gameobject: {content.name} doesn't have RectTransform component!");
                }
#endif
        ...
        private void LogMessage(string text, Color? textColor)
        {
            ...
            bool success = SpawnMessageFromPool(text, textColor);
            if (!success)
            {
                return;
            }
        ...
        {
            if (setupDone || messagePrefab == null || messageParent == null)
            {
                return;
            }
        ...
        private bool SpawnMessageFromPool(string message, Color? textColor)
        {
            ...
            if (objectToSpawn != null)
            {
                ...
                ConsoleMessage msg = messages[objectToSpawn];
                if (msg != null)
                {
        ...
        {
            if (messageCount >= 20 && !allGhostsHidden)
            {
                return;
            }

            int visible = 19 - messageCount;
