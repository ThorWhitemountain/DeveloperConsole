...
#pragma warning disable 1998
    public static class ConsoleManager
    {
        ...
        private static void Init()
        {
            ...
            UnityMainThreadID = Thread.CurrentThread;
        ...
        private static void OnDestroy()
        {
            ...
            {
                int executedCommandCount = CommandDatabase.GetExcecutedCommandCount();
                int failedCommandCount = CommandDatabase.GetFailedCommandCount();
        ...
        {
            if (settings == null || theme == ConsoleGUITheme.Custom)
            {
                return;
            }
        ...
        public static void ToggleInterfaceStyle(bool openConsole = true)
        {
            ...
            ConsoleGUIStyle style = settings.interfaceStyle == ConsoleGUIStyle.Large
                ? ConsoleGUIStyle.Minimal
                : ConsoleGUIStyle.Large;
            if (openConsole)
            {
                ConsoleEvents.CloseConsole();
        ...
        private static void RegisterCommands(string sceneName = "", LoadSceneMode mode = LoadSceneMode.Single,
            bool logMessage = true)
        {
            ...
            double time = Math.Round(timer.Elapsed.TotalMilliseconds, 1);
            string suffix = ".";
            ...
            DelayHelper delayUtil = DelayHelper.GetInstance();
            if (delayUtil != null)
            {
...
#if UNITY_EDITOR
                Debug.Log(
                    "DelayHelper Instance is null. Initializing without delay. You might miss some messages that were called in Awake/Start methods.");
#endif
