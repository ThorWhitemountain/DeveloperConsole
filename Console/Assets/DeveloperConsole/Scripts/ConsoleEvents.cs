...
namespace Anarkila.DeveloperConsole
{
    public static class ConsoleEvents
    {
        ...
        {
            RegisterConsoleStateChangeEvent?.Invoke(true);
        }

        public static void CloseConsole()
        {
            RegisterConsoleStateChangeEvent?.Invoke(false);
        }
        ...
        {
            RegisterConsoleEnabledEvent?.Invoke(true);
        }

        public static void DisableConsole()
        {
            RegisterConsoleEnabledEvent?.Invoke(false);
        }

        public static void SetConsoleEnabledState(bool enabled)
        {
            RegisterConsoleEnabledEvent?.Invoke(enabled);
        }

        public static event Action RegisterInputFieldSubmit;

        public static void InputFieldSubmit()
        {
            RegisterInputFieldSubmit?.Invoke();
        }

        public static event Action RegisterPreviousCommandEvent;

        public static void SearchPreviousCommand()
        {
            RegisterPreviousCommandEvent?.Invoke();
        }

        public static event Action RegisterFillCommandEvent;

        public static void FillCommand()
        {
            RegisterFillCommandEvent?.Invoke();
        }

        public static event Action<ConsoleGUIStyle> RegisterGUIStyleChangeEvent;

        public static void ChangeGUIStyle(ConsoleGUIStyle style)
        {
            RegisterGUIStyleChangeEvent?.Invoke(style);
        }

        public static void SwitchGUIStyle()
        {
            ConsoleManager.ToggleInterfaceStyle();
        }
        ...
        public static void Predictions(List<string> list)
        {
            RegisterConsolePredictionEvent?.Invoke(list);
        }
        ...
        {
            RegisterConsoleResetEvent?.Invoke();
        }
        ...
        {
            RegisterConsoleClearEvent?.Invoke();
        }

        public static event Action RegisterListsChangedEvent;

        public static void ListsChanged()
        {
            RegisterListsChangedEvent?.Invoke();
        }

        public static event Action RegisterSettingsChangedEvent;

        public static void NewSettingsSet()
        {
            RegisterSettingsChangedEvent?.Invoke();
        }

        public static event Action RegisterConsoleInitializedEvent;

        public static void ConsoleInitialized()
        {
        ...
        {
            RegisterConsoleScrollMoveEvent?.Invoke();
        }
        ...
        {
            RegisterSceneLoadByName?.Invoke(name);
        }
        ...
        {
            RegisterSceneUnLoadByName?.Invoke(name);
        }

        public static event Action<int, UnityEngine.SceneManagement.LoadSceneMode> RegisterSceneLoadByIndex;

        public static void LoadSceneByIndexSingle(int index)
        {
            RegisterSceneLoadByIndex?.Invoke(index, UnityEngine.SceneManagement.LoadSceneMode.Single);
        }

        public static void LoadSceneByIndexAdditive(int index)
        {
            RegisterSceneLoadByIndex?.Invoke(index, UnityEngine.SceneManagement.LoadSceneMode.Additive);
        }

        public static event Action<int> RegisterSceneUnLoadByIndex;

        public static void UnloadSceneByIndex(int index)
        {
            RegisterSceneUnLoadByIndex?.Invoke(index);
        }

        public static event Action<bool> RegisterListenActivatStateEvent;

        public static void SetListenActivateKeyState(bool enabled)
        {
            RegisterListenActivatStateEvent?.Invoke(enabled);
        }

        public static event Action<KeyCode> RegisterConsoleActivateKeyChangeEvent;

        public static void ChangeActivateKeyCode(KeyCode key)
        {
            RegisterConsoleActivateKeyChangeEvent?.Invoke(key);
        }

        public static event Action<float> RegisterDestroyEvent;

        public static void DestroyConsole(float time)
        {
            RegisterDestroyEvent?.Invoke(time);
        }
        ...
        {
            RegisterInputfieldTextEvent?.Invoke(text);
        }

        public static event Action RegisterConsoleColorsChangedEvent;

        public static void ConsoleColorsChanged()
        {
            RegisterConsoleColorsChangedEvent?.Invoke();
        }

        public static event Action<ConsoleLogOptions> RegisterConsoleLogOptionsChanged;

        public static void ChangeConsoleLogOptions(ConsoleLogOptions logOption)
        {
            RegisterConsoleLogOptionsChanged?.Invoke(logOption);
        }

        public static event Action<ConsoleLogOptions> RegisterConsoleThreadedLogOptionsChanged;

        public static void ChangeConsoleThreadedLogOptions(ConsoleLogOptions logOption)
        {
            RegisterConsoleThreadedLogOptionsChanged?.Invoke(logOption);
        }
        ...
        {
            RegisterInputPredctionChanged?.Invoke(showPredictions);
        }

        public static event Action<GameObject, PointerEventData, string> RegisterOnContextMenuShow;

        public static void ShowContextMenu(GameObject go, PointerEventData data, string msg)
        {
            RegisterOnContextMenuShow?.Invoke(go, data, msg);
        }
        ...
        {
            RegisterOnMessageDelete?.Invoke();
        }

        public static event Action<bool> RegisterOnCommandExecuted;

        public static void CommandExecuted(bool success)
        {
            RegisterOnCommandExecuted?.Invoke(success);
        }
    }
}