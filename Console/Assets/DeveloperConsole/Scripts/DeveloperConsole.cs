...
namespace Anarkila.DeveloperConsole
{
    ...
    public class DeveloperConsole : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            if (settings.interfaceStyle == ConsoleGUIStyle.Minimal && settings.allowGUIStyleChangeRuntime)
            {
                    ...
                    settings.unityThreadedLogOption != ConsoleLogOptions.DontPrintLogs)
                {
                    ...
                    Debug.Log(
                        "If you are only using Minimal console style, consider changing options UnityLogOption and unityThreadedLogOption to DontPrintLogs " +
            ...
            {
                Console.RegisterCommand(this, "ChangeConsoleGUI", "console_style",
                    info: "Change Console style between Large and Minimal", hiddenCommandMinimalGUI: false);
            }
        }
        ...
        private void OnValidate()
        {
            ...
            {
                Debug.Log(
                    "Did not find EventSystem in the current scene. EventSystem has been added to current scene.");
