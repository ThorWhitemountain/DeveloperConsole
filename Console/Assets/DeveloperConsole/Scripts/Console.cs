...
public static class Console
{
    ...
    public static void RegisterCommand(MonoBehaviour script, string methodName, string commandName,
        string defaultValue = "", string info = "",
        bool debugCommandOnly = false, bool isHiddenCommand = false, bool hiddenCommandMinimalGUI = false)
    {
        CommandDatabase.RegisterCommand(script, methodName, commandName, defaultValue, info, debugCommandOnly,
